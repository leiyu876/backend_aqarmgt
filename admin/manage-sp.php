                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card">
                                        <a href="add-service.html"><img class="card-img-top" src="../plugins/images/cards/sp1.jpg" alt="Card image cap" width="100%"></a>
                                        <div class="card-block">
                                            <h4 class="card-title">Add your skills as a Service</h4>
                                        </div>
                                   
                                        <div class="card-block" style="text-align: center;">
                                            <a href="add-service.html" class="btn btn-success"><span class="btn-label"><i class="fa fa-arrow-right"></i></span>Proceed</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-block" style="text-align: center;">
                                            <a href="services.html" class="btn btn-success"><span class="btn-label"><i class="fa fa-arrow-right"></i></span>Proceed</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-block" style="text-align: center;">
                                            <a href="create-new-shop.html" class="btn btn-success"><span class="btn-label"><i class="fa fa-arrow-right"></i></span>Proceed</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
