                            ...
                            <div id="exampleValidator" class="wizard">
                                <ul class="wizard-steps" role="tablist">
                                    <li class="active" role="tab">
                                        <h4><span><i class="fa fa-building"></i></span>Land Details</h4>
                                    </li>
                                    <li role="tab">
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label class="col-xs-6 control-label">Land Name</label>
														<div class="col-xs-5">
                                                    ...
                                                    <!--zaib-->
                                                    <div class="form-group">
														<label class="col-xs-6 control-label">Land Type</label>
														<div class="col-xs-5">
															<select class="form-control"  id="city">
                                                                <option value="1">Residential Land</option>
                                                                <option value="2">Commercial Land</option>
                                                                <option value="3">Irrigation Land</option>                                                             </select>
														</div>
													</div>
                                                    <div class="form-group">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="col-xs-6 control-label">Land Code</label>
														<div class="col-xs-5">
															<input type="text" class="form-control" name="name" />
														</div>
													</div>
                                                    <!--zaib-->
                                                    <div class="form-group">
														<label class="col-xs-6 control-label">Land For</label>
														<div class="col-xs-5">
                                        ...
                                        <div class="wizard-pane" role="tabpanel">
                                            <div class="row">
												...
												<div class="col-md-6">
													...
													<div class="form-group">
														<label class="col-xs-6 control-label">Evaluated Land Price</label>
														<div class="col-xs-5">
															<input type="text" class="form-control" name="name" />
														</div>
													</div>
