            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Create New Apartment</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="#">Manage Units</a></li>
                           
                            <li class="active">Create New Apartment</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                                        ...
                                        <div class="wizard-pane active" role="tabpanel">
											<div class="row">
												<div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
														<label class="col-xs-6 control-label">Level No</label>
														<div class="col-xs-5">
															<input type="text" class="form-control" name="name" />
														</div>
													</div>
												...
												<div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
														<label class="col-xs-6 control-label">Select Building</label>
														<div class="col-xs-5">
															<select class="form-control"  id="building_id">
                                                                <option value="0">Building A</option>
                                                                <option value="1">Building B</option>
                                                                <option value="2">Building C</option>                                                             </select>
														</div>
													</div>
                                                    <div class="col-md-6">
                                                    <div class="form-group">
