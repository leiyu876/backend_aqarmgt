                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Create New Unit</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                            ...
                            <div id="exampleValidator" class="wizard">
                                <ul class="wizard-steps" role="tablist">
                                    <li class="active" role="tab">
                                        <h4><span><i class="fa fa-building"></i></span>Unit Details</h4>
                                    </li>
                                    <li role="tab">
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label class="col-xs-6 control-label">Unit Name</label>
														<div class="col-xs-5">
													...
													<!--zaib-->
                                                    <div class="form-group">
														<label class="col-xs-6 control-label">Unit Type</label>
														<div class="col-xs-5">
															<select class="form-control"  id="unit_type" >
                                                                <option value="1">Apartment</option>
                                                                <option value="2">Office</option>
                                                                <option value="3">Shop</option>                                                             </select>
														</div>
													</div> 
                                                    <div class="form-group">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="col-xs-6 control-label">Unit Code</label>
														<div class="col-xs-5">
															<input type="text" class="form-control" name="name" />
														</div>
													</div>
													<!--zaib-->
                                                    <div class="form-group">
														<label class="col-xs-6 control-label">Unit For</label>
														<div class="col-xs-5">
															<select class="form-control"  id="unit_for">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="checkbox checkbox-info checkbox-circle">
                                                ...
                                                <div class="col-md-12">
                                                <div class="form-group">
                                                <div id='unit_detail' class="visible">
                                                
                                                <div class="row">
                                        <div class="col-sm-4">
                                            <label for="tch1" ><span><img src="../plugins/images/property/pro-bed.png"></span> <span>Bedrooms</label>
                                        ...
                                        <div class="col-sm-4">
                                            <label for="tch2"><span><img src="../plugins/images/property/pro-garage.png"></span> <span>Garages</label>
                                        ...
                                        <div class="col-sm-4">
                                            <label for="tch3"><span><img src="../plugins/images/property/pro-bath.png"></span> Bathrooms</label>
                                        ...
                                        <div class="wizard-pane" role="tabpanel">
                                            <div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label class="col-xs-6 control-label">Unit Area</label>
														<div class="col-xs-5">
															<input type="text" class="form-control" name="name" />
														</div>
													</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="col-xs-6 control-label">Unit Price/Rent</label>
														<div class="col-xs-5">
															<input type="text" class="form-control" name="name" />
														</div>
													</div>
