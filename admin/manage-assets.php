            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Assets List</h4> </div>
                    <!-- /.page title -->
                    <!-- .breadcrumb -->
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
							<li><a class="btn btn-block btn-success" href="create-asset.html" style="color: #fff"><span class="btn-label"><i class="fa fa-plus"></i></span>Create New Asset</a></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="white-box">
                            <div class="product-img">
                                ...
                                <div class="pro-img-overlay"><a href="edit-asset.html" class="bg-info"><i class="ti-marker-alt"></i></a> <a href="javascript:void(0)" id="dc" class="bg-danger"><i class="ti-trash"></i></a></div>
                            </div>
                            <div class="product-text">
                                <span class="pro-price bg-danger">SR 150</span>
                                <h3 class="box-title m-b-0">Rounded Chair</h3>
                                <small class="text-muted db">Asset Code: 26498</small>
                                <small class="text-muted db">Quantity: 5</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="white-box">
                            <div class="product-img">
                                ...
                                <div class="pro-img-overlay"><a href="edit-asset.html" class="bg-info"><i class="ti-marker-alt"></i></a> <a href="javascript:void(0)" class="bg-danger"><i class="ti-trash"></i></a></div>
                            </div>
                            <div class="product-text">
                                <span class="pro-price bg-success">SR 200</span>
                                <h3 class="box-title m-b-0">Dustpan and Brush</h3>
                                <small class="text-muted db">Asset Code: 29548</small>
                                <small class="text-muted db">Quantity: 16</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="product-text">
                                ...
                                <h3 class="box-title m-b-0">Chair</h3>
                                <small class="text-muted db">Asset Code: 29549</small>
                                <small class="text-muted db">Quantity: 15</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="product-text">
                                ...
                                <h3 class="box-title m-b-0">Simple Chair</h3>
                                <small class="text-muted db">Asset Code: 29595</small>
                                <small class="text-muted db">Quantity: 12</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="product-text">
                                ...
                                <h3 class="box-title m-b-0">Rounded Chair</h3>
                                <small class="text-muted db">Asset Code: 26498</small>
                                <small class="text-muted db">Quantity: 10</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="product-text">
                                ...
                                <h3 class="box-title m-b-0">Chair</h3>
                                <small class="text-muted db">Asset Code: 29549</small>
                                <small class="text-muted db">Quantity: 2</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
